...
## Desarrollo
Este proyecto está desarrollado en REACT y cuenta con Redux, HTML5, CSS3 y javaScript. Para la edición de las imágenes, he utilizado Adobe Photoshop y para el desarrollo del código Visual Studio Code.
